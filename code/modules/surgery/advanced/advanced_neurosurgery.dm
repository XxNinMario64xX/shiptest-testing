...
/datum/surgery_step/advanced_neurosurgery
	...
	implements = list(
		TOOL_HEMOSTAT = 95,
		/obj/item/melee/transforming/energy/sword = 25, // What the fuck
		/obj/item/kitchen/knife = 15, /// Are you doing
		/obj/item/shard = 10, // Using this shit for
		/obj/item = 5) // For neurosurgery
	time = 20 SECONDS
